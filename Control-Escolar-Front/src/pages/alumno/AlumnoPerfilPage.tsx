...
import Modal from '../../components/ui/Modal';  // Por defecto
...
// --- 1. MODAL: DETALLES PERSONALES (REFACTORIZADO) ---
...
            {/* Sección Inferior: Recuadro Azul "Información Adicional" - USAMOS CARD FLAT */}
...
// --- 2. MODAL: DATOS ACADÉMICOS (REFACTORIZADO) ---
...
            {/* Sección Inferior: Recuadro Azul - USAMOS CARD FLAT */}
            <Card variant="flat" className="bg-[#f0f5fa] p-5 rounded-lg border-none">
                <h4 className="font-bold text-gray-700 mb-4 text-base">Información Adicional</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8">
...
// --- 3. MODAL: EDITAR INFORMACIÓN (REFACTORIZADO) ---
...
// --- PÁGINA PRINCIPAL: AlumnoPerfilPage (REFACTORIZADO) ---
